...
urlpatterns = [
    ...
    path("saving_types/", views.manage_saving_types, name="manage_saving_types"),
    path("saving_types/<int:saving_type_id>/", views.manage_saving_type_detail, name="manage_saving_type_detail"),
